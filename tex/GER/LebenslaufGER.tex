...
\centering
\begin{tikzpicture}
			\node [inner sep=0pt] at (0,0) {\includegraphics[trim=0cm 0cm 0.1cm 0.8cm, clip,scale = 1.2]{../../img/ichich2.png}};
			\draw [anti-flashwhite, rounded corners=0, line width=0]
...
%	\includegraphics[trim=0cm 0cm 0cm 0cm, clip,scale=0.38]{../../img/globalEXPENG.pdf}
	...
	\begin{itemize}
		...
		\item[\textbf{Englisch}]  \includegraphics[scale=0.50]{../../img/5stars.png}\vspace{-2mm}
