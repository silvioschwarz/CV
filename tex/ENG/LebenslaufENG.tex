...
\centering
\begin{tikzpicture}
			\node [inner sep=0pt] at (0,0) {\includegraphics[trim=0cm 1cm 0cm 4cm, clip,scale = 0.12]{../img/me.jpg}};
...
\end{document}
	%\vspace{2cm}
%
	\subsubsection*{\fontsize{18pt}{24pt}\selectfont \color{pblue}Projects}
			\begin{itemize}
				\item TerrorXAfrica \href{https://terrorxafrica.herokuapp.com}{} A 22h HPI hackathon
				\item TerremotoPi \href{https://github.com/silvioschwarz/TerremotoPi}{} A seismic station powered by a Raspberry Pi
				\item EQS2S \href{https://github.com/silvioschwarz/Earthquake-Distances}{\faGithub} Calculation of source to site distances\\\\\
			\end{itemize}
%\vspace{2cm}
