...
\begin{minipage}[t]{0.25\textwidth}
	...
	\centering
	\begin{tikzpicture}
		\node [inner sep=0pt] at (0,0) {\includegraphics[trim=0cm 0cm 0cm 0.75cm, clip,scale = 0.92]{../../img/ichich2.png}};
	...
	{\Large
		...
		\href{ www.kaggle.com/amethodtomadness/}{\includegraphics{../../img/kaggle.png}}}
	...
	\begin{tikzpicture}[node distance = 7mm, terminal/.style={
					rectangle, minimum height = 2mm, rounded corners = 1mm, thick,
					draw = darkgray, fill = white, align = left}]
		\node (A) [terminal] {seismic hazard analysis};
		\node (AA) [terminal, below=of A.west,anchor=west] {IoT};
		\node (B) [terminal, right=2mm of AA.east,anchor=west] {ground motion};
		\node (AAA) [terminal,  below=of AA.west,anchor=west] {machine learning};
		\node (AAAA) [terminal,  below=of AAA.west,anchor=west] {bayesian inference};
	\end{tikzpicture}
	\vspace{2mm}
	\hrule
	\vspace{-2mm}
	\section*{\fontsize{18pt}{24pt}\selectfont \color{pblue} Certificates}
	\centering
	\vspace{-2mm}
	...
	\vspace{-2mm}
	\vfill
	\includegraphics[trim=6cm 1cm 6cm 1cm, clip,scale=0.23]{../../img/wordcloud2.pdf}
...
\begin{minipage}[t]{0.70\textwidth}
	...
	\begin{minipage}[t]{\minipageBigEd\textwidth}
		...
		\textbf{\underline{Earth Sciences}}\hfill{cancelled due to illness}\\
		\textbf{\underline{Focus:}~Geophysics, machine learning}\\
		\textbf{\underline{Thesis}}:\\ 1) \href{https://github.com/silvioschwarz/master-thesis}{Forecasting Macroseismic Intensities: A Sensitivity Study of a Bayesian Approach 2014-2016} \\
	...
	\begin{minipage}[t]{\minipageBig\textwidth}
		...
		\href{http://www.geo.uni-potsdam.de/allgemeine-geophysik-1570.html}{General Geophysics Group}\\
	...
	%				Improvement of GMPE\\
	%				\textbf{\underline{Supervision}}: \href{mailto:MKaeser@munichre.com}{\color{pblue}Prof. Dr. Martin Käser}%https://www.geophysik.uni-muenchen.de/Members/kaeser/cv
	%				\end{minipage}
	...
	\vspace{\spacingWork}
		...
		\textbf{\color{pblue}\href{https://earthquake-distances.herokuapp.com}{EQDist}}\\ {Calculation and visualization of source-to-site distances for ground motion modelling} \vspace{1mm} \\
		\textbf{\color{pblue}\href{https://silvioschwarz.github.io/TerremotoPi/}{TerremotoPi}}\\ {A RaspberryPi powered seismic station with real-time capabilities} \vspace{1mm}\\
		\textbf{\color{pblue}\href{https://terrorxafrica.herokuapp.com}{TerrorXAfrica}}\\ {IBM cross-border effects challenge of armed conflicts at \href{https://hackhpi2019.devpost.com}{\color{pblue}HackHPI2019} }
		\end{minipage}
